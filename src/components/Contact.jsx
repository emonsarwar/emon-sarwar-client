...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative py-24 px-6 bg-slate-950 overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-125 h-125 bg-sky-600/5 blur-[120px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="absolute -inset-4 bg-linear-to-tr from-sky-500/10 to-blue-500/10 blur-2xl rounded-[3rem] -z-10" />
          </motion.div>
        </div>
      </div>
    </section>
