...
export default function Footer() {
  ...
  const socialLinks = [
    { 
      icon: <FaGithub />, 
      href: "https://github.com/emonsarwar110", 
      label: "GitHub" 
    },
    { 
      icon: <FaLinkedin />, 
      href: "https://www.linkedin.com/in/emon-sarwar-78b853245", 
      label: "LinkedIn" 
    },
    { 
      icon: <FaTwitter />, 
      href: "https://x.com/EMONSARWAR110", 
      label: "Twitter" 
    },
    { 
      icon: <FaFacebook />, 
      href: "https://www.facebook.com/emonsarwardorjoy", 
      label: "Facebook" 
    },
    { 
      icon: <FaEnvelope />, 
      href: "mailto:emonsarwar110@gmail.com", 
      label: "Email" 
    },
  ];
    ...
    <footer className="relative bg-slate-950 pt-20 pb-10 px-6 border-t border-slate-900 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12 mb-16">
          ...
          >
            <div className="text-2xl font-black tracking-tighter text-white mb-2 uppercase">
              EMON<span className="text-sky-500">SARWAR</span>
            </div>
            <p className="text-slate-500 text-sm font-medium tracking-widest uppercase">
              Under Graduation Student | Tech Enthusiast
            </p>
          </motion.div>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {socialLinks.map((social, index) => (
              <motion.a
                ...
                whileTap={{ scale: 0.9 }}
                className="relative p-4 rounded-2xl bg-slate-900 border border-slate-800 text-slate-400 hover:text-sky-500 hover:border-sky-500/50 transition-all duration-300 group shadow-xl"
              >
                <span className="text-xl">{social.icon}</span>
                {/* Tooltip */}
                <span className="absolute -top-10 left-1/2 -translate-x-1/2 bg-sky-500 text-slate-950 text-[10px] font-bold px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none uppercase tracking-tighter whitespace-nowrap">
                  {social.label}
                </span>
              </motion.a>
            ))}
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 text-slate-500 text-xs font-bold tracking-widest uppercase">
          <p>&copy; {new Date().getFullYear()} Emon Sarwar. All Rights Reserved</p>
